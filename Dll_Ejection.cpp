...
BOOL SetPrivilege(LPCTSTR lpszPrivilege, BOOL bEnablePrivilege) {
	...
	// Enable the privileg or disable all privileges
	if (!AdjustTokenPrivileges(hToken, FALSE, &tp, sizeof(TOKEN_PRIVILEGES), (PTOKEN_PRIVILEGES)NULL, (PDWORD)NULL)) {
		_tprintf(L"AdustTokenPrivileges error : %u\n", GetLastError());
		return FALSE;
	}
...
BOOL EjectionDll(DWORD dwPID, LPCTSTR szDllName) {
...
int _tmain(int argc, TCHAR* argv[]) {
	...
	// eject dll
	if (EjectionDll(dwPID, DEF_DLL_NAME))
